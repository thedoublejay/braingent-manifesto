...
This is the manually curated map of the memory repo.

## Read Always

- `README.md` - repo purpose and layout.
- `CURRENT_STATE.md` - current state and active initiatives.
...
- `preferences/planning.md` - planning expectations.
- `preferences/code-review.md` - review expectations.
- `preferences/pr-and-commit.md` - commit and PR hygiene.
- `preferences/privacy-and-safety.md` - what must not be stored.

## Organizations

- `orgs/org--example/README.md`
...
- `topics/topic--ai-memory/README.md`
...
- `braingent find`, `braingent recall`, `braingent validate`, `braingent reindex`, `braingent doctor`.
- `braingent qa generate` - generate QA plans from tickets, memory, and optional Gather Step evidence.
- `braingent mcp serve` - MCP server exposing token-efficient Braingent retrieval.

## People

- Add professional collaboration notes under `people/person--<slug>/README.md` only when useful and appropriate.
...
- `templates/tool-version-record.md`
- `templates/person-interaction-record.md`
- `templates/ticket-stub.md`
- `templates/import-summary-record.md`
